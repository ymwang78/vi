...
namespace zdp
{
    ...
    int zdp_pack(const zdp_base::MSG_CONN_REQ& _t, zce_byte* buf, int size, zce_byte version);
    int zdp_unpack(zdp_base::MSG_CONN_REQ& _t, const zce_byte* buf, int size, zce_byte version);
    zce_int32 zdp_body_length(const zdp_base::MSG_CONN_REQ& _t, zce_byte version);
    zce_int32 zdp_total_length(const zdp_base::MSG_CONN_REQ& _t, zce_byte version);
